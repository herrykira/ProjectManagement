...
public interface UserService {
    ...
    public Call<SubTaskStatusResponse> getSubTaskEdit(@Query("taskid") String taskid, @Query("subtaskid") String subtaskid, @Query("project_id") String projectid, @Query("userid") String userid, @Query("subtask_status") String status);
    @GET("pms_edit_task_status.php")
    public Call<SubTaskStatusResponse> getTaskEdit(@Query("taskid") String taskid, @Query("project_id") String projectid, @Query("userid") String userid, @Query("task_status") String taskstatus);
